import { type TeamsMockStructure, type TeamsStructure } from "../../types";
...
export const mockedTokenPayload = {
  sub: "6470dd683e5b23e0fea64b08",
  name: "fede",
  iat: 1685516575,
  exp: 1685689375,
};
...
export const mockedSingleTeam: TeamsMockStructure[] = [
  {
    id: "6471d07c47109a6b3fc62df8",
    name: "On Fire !",
    description:
